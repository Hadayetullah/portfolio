        ...
        <section className="qualification section">
            ...
            <div className="qualification__tabs">
                ...
                <div 
                    ...
                    className={`qualification__button button--flex ${qualification === 'acquired' ? 'qualification__active' : ''}`}
                >
            ...
            <div className="qualification__sections">
                ...
                <div className={`qualification__content ${qualification === 'education' ? 'qualification__active' : ''}`} data-content>
                {/* <!--==================== QUALIFICATION 1 ====================--> */}
                <div className="qualification__data">
                    <div>
                    <h3 className="qualification__title">BSc in CSE</h3>
                    <span className="qualification__subtitle">Southeast University</span>
                ...
                <div className="qualification__data">
                    ...
                    <span className="qualification__subtitle">Sirajganj Police Lines School and College</span>
                ...
                <div className="qualification__data">
                    ...
                    <span className="qualification__subtitle">Alokdia Model Madrasha</span>
                ...
                <div className={`qualification__content ${qualification === 'acquired' ? 'qualification__active' : ''}`} data-content>
                {/* <!--==================== QUALIFICATION 1 ====================--> */}
                <div className="qualification__data">
                    <div>
                    <h3 className="qualification__title">Learning Next.js</h3>

        ...
        <div className="home__container container grid">
          <div className="home__content grid">
            <div className="home__social">
              <a
                href="https://www.linkedin.com/in/md-hadayetullah-964672150/"
              ...
              <a
                href="https://github.com/Hadayetullah"
                className="home__social-icon"
                target="_blank"
              >
                <UilGithubAlt />
              ...
              <a
                href="https://www.facebook.com/hadayet00/"
                className="home__social-icon"
                target="_blank"
              >
                <UilFacebookF />
              ...
              >
                ...
                <g mask="url(#mask0)">
                  ...
                  <image
                    ...
                    x="6"
                    y="-13"
                    href="assets/img/hadayetullah.png"
                  />
                </g>
              </svg>
            </div>

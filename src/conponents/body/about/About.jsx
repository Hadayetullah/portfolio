      ...
      <section className="about section" id="about">
        ...
        >
          <div className="about__content">
            <img src="/assets/img/about3.png" alt="" className="about__img1" />
            ...
            <div className="about__info">
              ...
              <div>
                <span className="about__info-title">
                  08<span className="job__experience-animate">+</span>
                </span>
                <span className="about__info-name">
                  Months job
                  <br /> experience
          ...
          <img src="/assets/img/about3.png" alt="" className="about__img2" />
          ...
          <div className="about__data">
            ...
            <div className="about__info">
              ...
              <div>
                <span className="about__info-title">
                  04<span className="job__experience-animate">+</span>
                </span>
                <span className="about__info-name">
                  Months job
                  <br /> experience
